...
* Back in RStudio, test that the package can be installed using devtools::install_github(). First close out of the project for your package, then run the install instructions that you have clevery remembered to include in the readme file. 
